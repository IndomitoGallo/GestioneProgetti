...
public class UserController {
     ...
     * con id passato nell'url della richiesta prendendo i valori che servono dal body della richiesta
     * passato in ingresso.
     * Angular inserirà all'interno della richiesta HTTP un JSON contenente: un oggetto di tipo User ed una
     * lista contentente numeri interi, ad indicare i nuovi profili da associare con l'utente. Inoltre
     * viene inserito anche l'id della sessione.
     * Viene quindi creato l'oggetto UserProfilesRQS per trasportare le informazioni verso lo strato dei
     ...
     * con l'id della sessione, altrimenti se la response contiene "false" lo status restituito è BAD_REQUEST
     * e se contiente "FAIL" lo status restituito è SERVICE_UNAVAILABLE.
